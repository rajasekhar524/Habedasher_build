...
function HeadermobileV() {
  ...
  return (
    <div className='header_mobilev_sec'>
      <div className={colorChange? 'header_mobilev_sec_bg_trans' : 'header_mobilev_sec_bg_white'}>
        <div className={colorChange?'header_mobilev_sec_hamburger_trans':'header_mobilev_sec_hamburger_white'}>
        ...
        <div className={colorChange?'header_mobilev_sec_logo_trans':'header_mobilev_sec_logo_white'}>
            <Link to="/">
              <img src='https://i.postimg.cc/D0Fx09R9/logo-large.png' alt ='aasd'/>
            </Link> 
        </div>
        <div className={colorChange?'header_mobilev_sec_icons_trans':'header_mobilev_sec_icons_white'}>
